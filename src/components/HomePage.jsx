...
useEffect(() => {
    ...
    return (
        <>
            ...
            <div className="back1">
                <img src={back} className='back1_img' style={{
            ...
            <div className='details'>
                <div className="details_container">
                    <div className="content">
                        ...
                        <div className="details_image_res" data-aos="fade-up2" data-aos-duration="800" data-aos-easing="ease-in-out" data-aos-offset="10">
                            <img src={whole} alt="" />
                        </div>
                    ...
                    <div className="details_image">
                        <img src={whole} className='zoomAnimation' alt="" />
                    </div>
                </div>

                <div className="details_container">
                    <div className="details_image im2">
                        <img src={ground} className='zoomAnimation'  alt="" />
                    </div>
                    <div className="content cn2 ">
